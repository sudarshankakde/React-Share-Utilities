...
export default function ShareFallbackModal({
  ...
  const isShareObj = (d: ShareInput | null): d is ShareData => {
    ...
    return "url" in d || "title" in d || "text" in d || "files" in d;
  };
  ...
  const resolvedTitle = isShareObj(data)
        ...
        <div className="fallback-content">
          ...
          {(resolvedUrl || resolvedTitle || resolvedText) && (
            <div className="fallback-preview-card">
              {resolvedTitle && (
                <div className="fallback-preview-title">{resolvedTitle}</div>
              )}
              {resolvedText && (
                <div className="fallback-preview-text">{resolvedText}</div>
              )}
              {resolvedUrl && (
